...
use utf8;
    ...
    my $parsed = $template->parse_file('t/04_Plugable_Core/template/xslate_compatible.txt');
    my $expected = $template->get_file('t/04_Plugable_Core/template/xslate_compatible_expected.txt');
