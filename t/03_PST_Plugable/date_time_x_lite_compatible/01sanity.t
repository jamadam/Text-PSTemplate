...
{
    my $dt = new Text::PSTemplate::DateTime( year => 1870, month => 10, day => 21,
    ...
    $dt = Text::PSTemplate::DateTime->from_object( object => $dt );
...
{
    my $dt = Text::PSTemplate::DateTime->new( year => 1870, month => 10, day => 21,
                            hour => 12, minute => 10, second => 45,
                            time_zone => 'UTC' );
    is( $dt->minute, '10', "Minute accessor, outside the epoch" );
    is( $dt->second, '45', "Second accessor, outside the epoch" );
