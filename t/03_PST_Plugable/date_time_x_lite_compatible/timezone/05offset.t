...
is( Text::PSTemplate::DateTime::TimeZone::offset_as_string(0), "+0000",
    "offset_as_string does the right thing on 0" );
is( Text::PSTemplate::DateTime::TimeZone::offset_as_string(3600), "+0100",
    "offset_as_string works on positive whole hours" );
is( Text::PSTemplate::DateTime::TimeZone::offset_as_string(-3600), "-0100",
    "offset_as_string works on negative whole hours" );
is( Text::PSTemplate::DateTime::TimeZone::offset_as_string(5400), "+0130",
    "offset_as_string works on positive half hours" );
is( Text::PSTemplate::DateTime::TimeZone::offset_as_string(-5400), "-0130",
    "offset_as_string works on negative half hours" );
is( Text::PSTemplate::DateTime::TimeZone::offset_as_string(20700), "+0545",
    "offset_as_string works on positive 15min zones" );
is( Text::PSTemplate::DateTime::TimeZone::offset_as_string(-20700), "-0545",
    "offset_as_string works on negative 15min zones" );
is( Text::PSTemplate::DateTime::TimeZone::offset_as_string(359999), "+995959",
    "offset_as_string max value" );
is( Text::PSTemplate::DateTime::TimeZone::offset_as_string(-359999), "-995959",
    "offset_as_string min value" );
is( Text::PSTemplate::DateTime::TimeZone::offset_as_string(360000), undef,
...
foreach ( @offset_seconds ) {
    is( Text::PSTemplate::DateTime::TimeZone::offset_as_seconds(
            Text::PSTemplate::DateTime::TimeZone::offset_as_string( $_ )
        ),
...
foreach ( @offset_strings ) {
    is( Text::PSTemplate::DateTime::TimeZone::offset_as_string(
            Text::PSTemplate::DateTime::TimeZone::offset_as_seconds( $_ )
        ),
...
is( Text::PSTemplate::DateTime::TimeZone->offset_as_seconds('+0100'), 3600,
    'offset_as_seconds as class method' );

{
    Text::PSTemplate::DateTime::TimeZone::offset_as_string(3600);
...
{
    Text::PSTemplate::DateTime::TimeZone::offset_as_seconds("+0100");
