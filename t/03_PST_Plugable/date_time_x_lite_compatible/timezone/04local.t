...
use Text::PSTemplate::DateTime::TimeZone::Local;
use Text::PSTemplate::DateTime::TimeZone::Local::Unix;
...
my @aliases = sort keys %{ Text::PSTemplate::DateTime::TimeZone::links() };
my @names = Text::PSTemplate::DateTime::TimeZone::all_names();
...
Text::PSTemplate::DateTime::TimeZone::Local->_load_subclass();

{
    ...
    {
        local $ENV{TZ} = $alias;
        my $tz = eval { Text::PSTemplate::DateTime::TimeZone::Local->TimeZone() };
...

{
    ...
    my $tz = Text::PSTemplate::DateTime::TimeZone::Local::Unix->FromEnv();
    is( $tz, undef,
        'invalid time zone name in $ENV{TZ} fails' );

    local $ENV{TZ} = '123/456';

    $tz = Text::PSTemplate::DateTime::TimeZone::Local::Unix->FromEnv();
    is( $tz, undef,
        'invalid time zone name in $ENV{TZ} fails' );
}

{
    ...
    local $ENV{TZ} = 0;
    $tz = eval { Text::PSTemplate::DateTime::TimeZone::Local->TimeZone() };
    is( $tz->name(), 'UTC',
...

{
    ...
    Text::PSTemplate::DateTime::TimeZone::Local::Unix->FromEnv();
...
SKIP:
{
    ...
    local *Text::PSTemplate::DateTime::TimeZone::Local::Unix::_Readlink = sub { '/usr/share/zoneinfo/US/Eastern' };

    my $tz;
    eval { $tz = Text::PSTemplate::DateTime::TimeZone::Local::Unix->FromEtcLocaltime() };
    ...
    local *Text::PSTemplate::DateTime::TimeZone::Local::Unix::_Readlink = sub { '/usr/share/zoneinfo/Foo/Bar' };

    $tz = Text::PSTemplate::DateTime::TimeZone::Local::Unix->FromEtcLocaltime() ;
    is( $@, '', 'valid time zone name in /etc/localtime symlink should not leave $@ set' );
    ok( ! $tz, 'no time zone was found' );


    local *Text::PSTemplate::DateTime::TimeZone::Local::Unix::_Readlink = sub { undef };
    local *Text::PSTemplate::DateTime::TimeZone::Local::Unix::_FindMatchingZoneinfoFile = sub { 'America/Los_Angeles' };
...
SKIP:
{
    ...
    local *Text::PSTemplate::DateTime::TimeZone::Local::Unix::_ReadEtcSysconfigClock = sub { 'US/Eastern' };

    my $tz;
    eval { $tz = Text::PSTemplate::DateTime::TimeZone::Local::Unix->FromEtcSysconfigClock() };
...
SKIP:
{
    ...
    local *Text::PSTemplate::DateTime::TimeZone::Local::Unix::_ReadEtcDefaultInit = sub { 'Asia/Tokyo' };

    my $tz;
    eval { $tz = Text::PSTemplate::DateTime::TimeZone::Local::Unix->FromEtcDefaultInit() };
...
SKIP:
{
...

    {
        ...
        my $tz;
        eval { $tz = Text::PSTemplate::DateTime::TimeZone::Local->TimeZone() };
    ...
    {
        local *Text::PSTemplate::DateTime::TimeZone::Local::Unix::FromEtcLocaltime = sub { undef };
...

    {
        ...
        local *Text::PSTemplate::DateTime::TimeZone::Local::Unix::FromEtcLocaltime = sub { undef };
        local *Text::PSTemplate::DateTime::TimeZone::Local::Unix::FromEtcTimezone = sub { undef };
        local *Text::PSTemplate::DateTime::TimeZone::Local::Unix::FromEtcTIMEZONE = sub { undef };
...
SKIP:
{
    ...
    Text::PSTemplate::DateTime::TimeZone::Local::Unix->FromEtcTimezone();
...
SKIP:
{
...

    {
        ...
        $tz = Text::PSTemplate::DateTime::TimeZone::Local->TimeZone();
...

{
    ...
    my $tz = eval { Text::PSTemplate::DateTime::TimeZone->load( name => 'local' ) };
    is( $tz->name(), 'Australia/Melbourne',
...
SKIP:
{
    ...
    is( basename( Text::PSTemplate::DateTime::TimeZone::Local::Unix->_Readlink( $third ) ),
        basename( $first ),
