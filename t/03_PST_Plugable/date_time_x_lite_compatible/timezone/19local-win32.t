...
my $Registry;
eval <<'EOF';
use Text::PSTemplate::DateTime::TimeZone::Local::Win32;
...
sub test_windows_zone
{
    ...
    my $tz = Text::PSTemplate::DateTime::TimeZone::Local::Win32->FromRegistry();

    ok( $tz && Text::PSTemplate::DateTime::TimeZone->is_valid_name( $tz->name() ),
