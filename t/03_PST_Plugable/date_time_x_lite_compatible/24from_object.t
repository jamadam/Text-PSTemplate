...
{
    my $t1 =
	Text::PSTemplate::DateTime::Calendar::_Test::WithoutTZ->new
	    ( rd_days => 1, rd_secs => 0 );
...

{
    ...
    my $t1 =
	Text::PSTemplate::DateTime::Calendar::_Test::WithTZ->new
...

{
    ...
    isa_ok( $t2, 'Text::PSTemplate::DateTime' );
    is( $t2->second, 60, 'new Text::PSTemplate::DateTime from_object with TZ which is a leap second' );
}
