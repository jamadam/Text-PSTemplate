...

{
    ...
    is( Text::PSTemplate::DateTime->compare($pos, $now),  1, 'positive infinite is greater than now' );
    is( Text::PSTemplate::DateTime->compare($neg, $now), -1, 'negative infinite is less than now' );
}
