...
# 1972-06-30
my $day = 720074;
is ( Text::PSTemplate::DateTime::LeapSecond::leap_seconds( $day ), 0, 'before leap-second transition'  );

is ( Text::PSTemplate::DateTime::LeapSecond::extra_seconds( $day ) + 0, 1, 'leap day'  );

# 1972-07-01
$day = 720075;
is ( Text::PSTemplate::DateTime::LeapSecond::leap_seconds( $day ), 1, 'day after leap-second day'  );
