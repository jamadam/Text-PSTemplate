...
use Text::PSTemplate::DateTime qw(Overload);

my $date1 = Text::PSTemplate::DateTime->new( year => 1997, month => 10, day => 24,
                           hour => 12, minute => 0, second => 0,
                           time_zone => 'UTC' );
my $date2 = Text::PSTemplate::DateTime->new( year => 1997, month => 10, day => 24,
                           hour => 12, minute => 0, second => 0,
                           time_zone => 'UTC' );
...
$date2 = Text::PSTemplate::DateTime->new( year => 1997, month => 10, day => 24,
...
$date2 = Text::PSTemplate::DateTime->new( year => 1997, month => 10, day => 25,
                        hour => 12, minute => 0, second => 0,
                        time_zone => 'UTC' );
ok($date1->compare($date2) == -1, 'Comparison $a < $b, 1 day diff');

$date2 = Text::PSTemplate::DateTime->new( year => 1997, month => 11, day => 24,
                        hour => 12, minute => 0, second => 0,
                        time_zone => 'UTC' );
ok($date1->compare($date2) == -1, 'Comparison $a < $b, 1 month diff');

$date2 = Text::PSTemplate::DateTime->new( year => 1998, month => 10, day => 24,
                        hour => 12, minute => 0, second => 0,
                        time_zone => 'UTC' );
...
$date2 = Text::PSTemplate::DateTime->new( year => 1997, month => 10, day => 23,
                        hour => 12, minute => 0, second => 0,
                        time_zone => 'UTC' );
ok($date1->compare($date2) == 1, 'Comparison $a > $b, 1 day diff');

$date2 = Text::PSTemplate::DateTime->new( year => 1997, month => 9, day => 24,
                        hour => 12, minute => 0, second => 0,
                        time_zone => 'UTC' );
ok($date1->compare($date2) == 1, 'Comparison $a > $b, 1 month diff');

$date2 = Text::PSTemplate::DateTime->new( year => 1996, month => 10, day => 24,
                        hour => 12, minute => 0, second => 0,
                        time_zone => 'UTC' );
ok($date1->compare($date2) == 1, 'Comparison $a > $b, 1 year diff');


my $infinity = Text::PSTemplate::DateTime::INFINITY;
...
# comparison with floating time
{
    ...
    is( Text::PSTemplate::DateTime->compare( $date1, $date2 ), 0, 'Comparison with floating time (cmp)' );
    is( ($date1 <=> $date2), 0, 'Comparison with floating time (<=>)' );
    is( ($date1 cmp $date2), 0, 'Comparison with floating time (cmp)' );
    is( Text::PSTemplate::DateTime->compare_ignore_floating( $date1, $date2 ), 1,
...
# sub-second
{
    ...
    is( Text::PSTemplate::DateTime->compare( $date1, $date2 ), -1, 'Comparison with floating time (cmp)' );
...
{
    my $dt = Text::PSTemplate::DateTime->new( year => 1950 );
