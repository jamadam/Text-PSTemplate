...
my $dt = Text::PSTemplate::DateTime->new( year => 2000, month => 1, day => 1, time_zone => 'UTC' )
    if $has_dt;
...
# testing the basics for all ids
{
    ...
    {
        my $locale = eval { Text::PSTemplate::DateTime::Locale->load($locale_id) };

        isa_ok( $locale, 'Text::PSTemplate::DateTime::Locale' );
...
sub check_root
{
    my $locale = Text::PSTemplate::DateTime::Locale->load('root');
...
sub check_en
{
    my $locale = Text::PSTemplate::DateTime::Locale->load('en');
...
sub check_en_GB
{
    my $locale = Text::PSTemplate::DateTime::Locale->load('en_GB');
...
sub check_en_US
{
    my $locale = Text::PSTemplate::DateTime::Locale->load('en_US');
...
sub check_es_ES
{
    my $locale = Text::PSTemplate::DateTime::Locale->load('es_ES');
...
sub check_af
{
    my $locale = Text::PSTemplate::DateTime::Locale->load('af');
...
{
    my $locale = Text::PSTemplate::DateTime::Locale->load('en_US_POSIX');
