...
use Text::PSTemplate::DateTime qw(Arithmetic ZeroBase);

my $d = Text::PSTemplate::DateTime->new( year => 2001,
                       month => 7,
                       day => 5,
                       hour => 2,
                       minute => 12,
...
my $leap_d = Text::PSTemplate::DateTime->new( year => 2004,
                            month => 7,
                            day => 5,
                            hour => 2,
                            minute => 12,
...
my $sunday = Text::PSTemplate::DateTime->new( year   => 2003,
                            month  => 1,
                            day    => 26,
                            time_zone => 'UTC',
                          );
...
my $monday = Text::PSTemplate::DateTime->new( year   => 2003,
                            month  => 1,
                            day    => 27,
                            time_zone => 'UTC',
                          );
...
{
    my $dt0 = Text::PSTemplate::DateTime->new( year => 1, time_zone => 'UTC' );
...
{
    my $dt_neg = Text::PSTemplate::DateTime->new( year => -10, time_zone => 'UTC', );
    is( $dt_neg->year, -10, "Year -10 is -10" );
    is( $dt_neg->ce_year, -11, "year -10 is ce_year -11" );

    SKIP: {
        skip "duration not yet implemented", 2;
    my $dt1 = $dt_neg + Text::PSTemplate::DateTime::Duration->new( years => 10 );
...
{
    my $dt = Text::PSTemplate::DateTime->new( year => 50, month => 2,
...
{
    my $dt = Text::PSTemplate::DateTime->new( year => 2000, month => 1, day => 5,
                            time_zone => 'UTC',
                          );
...
{
    my $dt = Text::PSTemplate::DateTime->new( year => 2000, month => 2, day => 29,
                            time_zone => 'UTC',
                          );
...
{
    my $dt = Text::PSTemplate::DateTime->new( year => -6, month => 2, day => 25,
                            time_zone => 'UTC',
                          );
...
{
    my $dt = Text::PSTemplate::DateTime->new( year => 1996, nanosecond => 500_000_000 );
...
{
    my $dt = Text::PSTemplate::DateTime->new( year => 2003, month => 5, day => 7 );
    is( $dt->weekday_of_month, 1, '->weekday_of_month' );
    is( $dt->week_of_month, 2, '->week_of_month' );
}

{
    my $dt = Text::PSTemplate::DateTime->new( year => 2003, month => 5, day => 8 );
    is( $dt->weekday_of_month, 2, '->weekday_of_month' );
    is( $dt->week_of_month, 2, '->week_of_month' );
}

{
    my $dt = Text::PSTemplate::DateTime->new( year => 1000, hour => 23 );
    is( $dt->hour,      23, '->hour' );
...
{
    my $dt = Text::PSTemplate::DateTime->new( year => 1000, hour => 0 );
    is( $dt->hour,       0, '->hour' );
