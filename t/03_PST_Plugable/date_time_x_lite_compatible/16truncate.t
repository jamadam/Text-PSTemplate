...
{
    my $dt = Text::PSTemplate::DateTime->new(%vals);
...
{
    my $dt = Text::PSTemplate::DateTime->new( year => 2003, month => 11, day => 17 );
    ...
    {
        my $dt =
            Text::PSTemplate::DateTime->new( year => 2003, month => 10, day => 2 )->truncate( to => 'week' );
