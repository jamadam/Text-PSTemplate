...
{
    my $date1 = Text::PSTemplate::DateTime->new( year => 2001, month => 5, day => 10,
			       hour => 4, minute => 3, second => 2,
			       nanosecond => 12,
			       time_zone => 'UTC' );

    my $date2 = Text::PSTemplate::DateTime->new( year => 2001, month => 6, day => 12,
...
{
    my $d = Text::PSTemplate::DateTime->new( year => 2001, month => 10, day => 19,
...
{
    my $dt1 = Text::PSTemplate::DateTime->new( year => 2003, month => 2, day => 9,
                             hour => 0, minute => 0, second => 1,
                             time_zone => 'UTC',
                           );

    my $dt2 = Text::PSTemplate::DateTime->new( year => 2003, month => 2, day => 7,
    ...
    is( Text::PSTemplate::DateTime->compare($dt1, $dt3), 0,
...
{
    my $dt1 = Text::PSTemplate::DateTime->new( year => 2000, month => 1, day => 5,
                             hour => 0, minute => 10, second => 0,
                             nanosecond => 1,
                             time_zone => 'UTC',
                           );

    my $dt2 = Text::PSTemplate::DateTime->new( year => 2000, month => 1, day => 6,
                             hour => 0, minute => 10, second => 0,
                             nanosecond => 0,
                             time_zone => 'UTC',
                           );
...

{
    ...
    my $dt2 = Text::PSTemplate::DateTime->new( year => 2000, month => 1, day => 5,
                             hour => 0, minute => 10, second => 0,
                             nanosecond => 10,
                             time_zone => 'UTC',
                           );
...
{
    my $dt1 = Text::PSTemplate::DateTime->new( year => 2005, month => 6, day => 11,
                             time_zone => 'UTC',
                           );

    my $dt2 = Text::PSTemplate::DateTime->new( year => 2005, month => 11, day => 10,
                             time_zone => 'UTC',
                           );
