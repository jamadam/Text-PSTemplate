...

{
    ...
    my $t1 = Text::PSTemplate::DateTime->from_epoch( epoch => 0 );
...
{
    my $epochtest = Text::PSTemplate::DateTime->from_epoch( epoch => '997121000' );
...

{
    ...
    my $dt = Text::PSTemplate::DateTime->new( year  => 1970,
                            month => 1,
                            day   => 1,
                            hour  => 0,
                            time_zone => '-0100',
...

{
    ...
    my $dt = Text::PSTemplate::DateTime->from_epoch( epoch => 0,
                                   time_zone => '-0100',
                                 );
...
{
    my $dt = Text::PSTemplate::DateTime->from_epoch( epoch => 0.5 );
...
{
    my $dt = Text::PSTemplate::DateTime->from_epoch( epoch => 0.1234567891 );
...
SKIP:
{
    ...
    is( Text::PSTemplate::DateTime->new( year => 1904 )->epoch, -2082844800,
