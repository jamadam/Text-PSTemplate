...

{
    my @dt = ( Text::PSTemplate::DateTime->new( year => 1950,
                              ...
                              language => 'ja',
                              # XXX - This doesn't work for me :( must be in the update-locales.pl code
                              # language => 'German' 
                            ),
               Text::PSTemplate::DateTime::Infinite::Past->new,
               Text::PSTemplate::DateTime::Infinite::Future->new,
             );
...
{
    my $dt1 = Text::PSTemplate::DateTime->now( locale => 'en_US' );
...
{
    my $has_ical = eval { require Text::PSTemplate::DateTime::Format::ICal; 1 };

 SKIP:
    {
        skip 'This test needs Text::PSTemplate::DateTime::Format::ICal', 1
            unless $has_ical;

        my $dt = Text::PSTemplate::DateTime->new( year      => 2004,
                                formatter => 'Text::PSTemplate::DateTime::Format::ICal',
                              );
