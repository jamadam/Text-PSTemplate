...
{
    my $dt = Text::PSTemplate::DateTime->new( year => 0 );
...
{
    my $dt = Text::PSTemplate::DateTime->new( year => 0, month => 12, day => 31 );
...
{
    my $dt = Text::PSTemplate::DateTime->new( year => -1 );
...

{
    ...
    for my $year (1, 0, -1)
    {
        ...
        {
            is( Text::PSTemplate::DateTime->from_day_of_year( year => $year,
                                            day_of_year => $doy,
                                          )->day_of_week,
                $dow,
