...
# say?"  this means it acts on the UTC components.
{
    ...
    $dt->add( hours => 1 );
    is( $dt->Text::PSTemplate::DateTime, '2003-04-06T01:00:00',
        'add one hour to midnight, get 1 am' );

    eval { $dt->add( hours => 1 ) };
    is( $@, '', 'no error adding 1 hour just before DST leap forward' );
    is( $dt->Text::PSTemplate::DateTime, '2003-04-06T03:00:00',
    ...
    $dt->subtract( hours => 1 );
    is( $dt->Text::PSTemplate::DateTime, '2003-04-06T00:00:00',
...

{
    ...
    $dt->add( hours => 1 );
    is( $dt->Text::PSTemplate::DateTime, '2003-10-26T01:00:00',
        'add one hour to midnight, get 1 am' );
    ...
    $dt->add( hours => 1 );
    is( $dt->Text::PSTemplate::DateTime, '2003-10-26T02:00:00',
    ...
    $dt->subtract( hours => 1 );
    is( $dt->Text::PSTemplate::DateTime, '2003-10-26T00:00:00',
...
# portion".  this means it acts on local components
{
    ...
    $dt->add( days => 1 );
    is( $dt->Text::PSTemplate::DateTime, '2003-04-07T00:00:00',
        'add 1 day at midnight, same clock time' );

    $dt->add( months => 7 );
    is( $dt->Text::PSTemplate::DateTime, '2003-11-07T00:00:00',
...

{
    ...
    $dt->add( days => 1 );
    is( $dt->Text::PSTemplate::DateTime, '2003-10-27T00:00:00',
        'add 1 day at midnight, get midnight' );

    $dt->add( months => 7 );
    is( $dt->Text::PSTemplate::DateTime, '2004-05-27T00:00:00',
...
# First we do date, then time.
{
    ...
    is( $dt1->Text::PSTemplate::DateTime, '2003-04-05T01:00:00',
    ...
    is( $dt2->Text::PSTemplate::DateTime, '2003-04-05T00:00:00',
...

{
    ...
    my $dt1 = $dt->clone->subtract( days => 1, hours => 2 );
    is( $dt1->Text::PSTemplate::DateTime, '2003-10-24T23:00:00',
        'add one day & 2 hours from midnight, get 11 pm' );

    my $dt2 = $dt->clone->subtract( hours => 2 )->subtract( days => 1 );
    is( $dt2->Text::PSTemplate::DateTime, '2003-10-25T00:00:00',
        'subtract 2 hours and then one day from 3 am, get midnight' );
}
...
# an example from the docs
{
    ...
    is(
        $dt->Text::PSTemplate::DateTime, '2003-04-06T03:00:00',
        'Text::PSTemplate::DateTime after adding 24 hours is 2003-04-06T03:00:00'
    );
}
