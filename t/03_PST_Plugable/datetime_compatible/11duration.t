...
{
    my $dur
        = Text::PSTemplate::DateTime::Duration->new( days => 1, end_of_month => 'preserve' );
    ok( $dur->is_preserve_mode, "preserve mode" );
}

my $leap_day = Text::PSTemplate::DateTime->new(
    year      => 2004, month => 2, day => 29,
    time_zone => 'UTC',
);

{
    my $new = $leap_day + Text::PSTemplate::DateTime::Duration->new(
        years        => 1,
        end_of_month => 'wrap'
    );
...

{
    ...
    my $new2 = $leap_day + Text::PSTemplate::DateTime::Duration->new(
        months       => 1,
        end_of_month => 'preserve'
    );
...
{
    my $inverse = Text::PSTemplate::DateTime::Duration->new(
        years => 1, months  => 1,
        weeks => 1, days    => 1,
    ...
    my $inverse2 = Text::PSTemplate::DateTime::Duration->new( years => 1 )
...
{
    my $dur1 = Text::PSTemplate::DateTime::Duration->new( months => 6, days => 10, seconds => 3,
        nanoseconds => 1_200_300_400 );

    my $dur2
        = Text::PSTemplate::DateTime::Duration->new( seconds => 1, nanoseconds => 500_000_000 );
...
{
    eval {
        Text::PSTemplate::DateTime::Duration->new( months => 3 )->add( hours => -3 )
            ->add( minutes => 1 );
    };
...

{
    ...
    is(
        Text::PSTemplate::DateTime::Duration->compare( $dur1, $dur2 ), -1,
        '20 minutes is greater than 10 minutes'
    );

    is(
        Text::PSTemplate::DateTime::Duration->compare(
            $dur1, $dur2, Text::PSTemplate::DateTime->new( year => 1 )
        ),
        -1,
        '20 minutes is greater than 10 minutes'
    );
...

{
    ...
    is(
        Text::PSTemplate::DateTime::Duration->compare( $dur1, $dur2, $base ), -1,
        '29 days is less than 1 month with base of 2004-01-01'
    );

    $base = Text::PSTemplate::DateTime->new( year => 2004, month => 2 );
    is(
        Text::PSTemplate::DateTime::Duration->compare( $dur1, $dur2, $base ), 0,
...
{
    my $dur1 = Text::PSTemplate::DateTime::Duration->new(
        nanoseconds => 1_000,
        seconds     => 1,
    );
    ...
    my $dur4 = Text::PSTemplate::DateTime::Duration->new(
        seconds     => -1,
...
{
    my $dur = Text::PSTemplate::DateTime::Duration->new(
        minutes => 30,
        seconds => -1,
    );
