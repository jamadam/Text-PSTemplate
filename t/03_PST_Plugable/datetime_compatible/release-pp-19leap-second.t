...
# tests using UTC times
{
    ...
    # subtract_Text::PSTemplate::DateTime
    my $t2 = Text::PSTemplate::DateTime->new(
        year      => 1972, month  => 07, day    => 1,
        hour      => 0,    minute => 0,  second => 20,
        time_zone => 'UTC',
    );
    my $dur = $t2->subtract_Text::PSTemplate::DateTime_absolute($t1);
    is( $dur->delta_seconds, 121, "delta_seconds is 121" );

    $dur = $t1->subtract_Text::PSTemplate::DateTime_absolute($t2);
    is( $dur->delta_seconds, -121, "delta_seconds is -121" );
}

{
    ...
    # subtract_Text::PSTemplate::DateTime, using floating times
...

{
    ...
    $t->add( seconds => 60 );
    is( $t->Text::PSTemplate::DateTime, '1972-06-30T20:59:20', "normal add" );
    is( $t->minute,   59,                    "min" );
    is( $t->second,   20,                    "sec" );

    $t->add( seconds => 60 );
    is( $t->Text::PSTemplate::DateTime, '1972-06-30T21:00:19', "add over a leap second" );
    is( $t->minute,   0,                     "min" );
    is( $t->second,   19,                    "sec" );

    $t->subtract( seconds => 20 );
    is( $t->Text::PSTemplate::DateTime, '1972-06-30T20:59:60', "subtract over a leap second" );
    is( $t->minute,   59,                    "min" );
    is( $t->second,   60,                    "sec" );
...

{
    ...
    is( $t->second, 0, 'Text::PSTemplate::DateTime just after leap second' );
}

{
    ...
    is( $t->second, 1, 'Text::PSTemplate::DateTime two seconds after leap second' );
}
...

{
    ...
    is( $t->second, 59, 'Text::PSTemplate::DateTime just before leap second' );
}
...

{
    ...
    $t->add( days => 1 );
    is(
        $t->Text::PSTemplate::DateTime, '1972-07-02T00:00:00',
    ...
    is(
        $t->Text::PSTemplate::DateTime, '1972-07-01T00:00:00',
        'add and subtract 1 day starting on leap second'
    );

    is( $t->leap_seconds, 1, 'Text::PSTemplate::DateTime has 1 leap second' );
}
...
{
    my $dt = Text::PSTemplate::DateTime->new( year => 2003, time_zone => 'UTC' );

    is( $dt->leap_seconds, 22, 'Text::PSTemplate::DateTime has 22 leap seconds' );
}

{
    my $dt = Text::PSTemplate::DateTime->new( year => 2003, time_zone => 'floating' );

    is( $dt->leap_seconds, 0, 'floating Text::PSTemplate::DateTime has 0 leap seconds' );
}
...
{
    my $dt1 = Text::PSTemplate::DateTime->new(
        year      => 1998, month  => 12, day    => 31,
        hour      => 23,   minute => 59, second => 60,
        time_zone => 'UTC',
    );

    my $dt2 = Text::PSTemplate::DateTime->new(
        year      => 1998, month  => 12, day    => 31,
...

{
    ...
    is( $dt->Text::PSTemplate::DateTime, '1972-07-02T23:58:20',
...
# a bunch of tests that math works across a leap second for various time zones
{
    ...
    is( $dt->Text::PSTemplate::DateTime, '1972-07-02T20:58:20',
...

{
    ...
    is( $dt->Text::PSTemplate::DateTime, '1972-07-03T02:58:20',
        "add two days crossing a leap second (+0300)" );
}
...

{
    ...
    is( $dt->Text::PSTemplate::DateTime, '1972-06-30T23:58:20',
...

{
    ...
    is( $dt->Text::PSTemplate::DateTime, '1972-06-30T20:58:20',
...

{
    ...
    is( $dt->Text::PSTemplate::DateTime, '1972-07-01T02:58:20',
        "subtract two days crossing a leap second (+0300)" );
}
...

{
    ...
    is( $dt->Text::PSTemplate::DateTime, '1972-06-30T12:58:20',
...

{
    ...
    is( $dt->Text::PSTemplate::DateTime, '1972-07-01T12:58:20',
        "24 hour time zone change near leap second" );
}

{
    ...
    is( $dt->Text::PSTemplate::DateTime, '1997-07-01T00:59:59', '+0100 time leap second T-1' );

    $dt->set_time_zone('UTC');

    is( $dt->Text::PSTemplate::DateTime, '1997-06-30T23:59:59', 'UTC time leap second T-1' );
}

{
    ...
    is( $dt->Text::PSTemplate::DateTime, '1997-07-01T00:59:60', 'local time leap second T-0' );

    $dt->set_time_zone('UTC');

    is( $dt->Text::PSTemplate::DateTime, '1997-06-30T23:59:60', 'UTC time leap second T-0' );
}

{
    ...
    is( $dt->Text::PSTemplate::DateTime, '1997-07-01T01:00:00', 'local time leap second T+1' );

    $dt->set_time_zone('UTC');

    is( $dt->Text::PSTemplate::DateTime, '1997-07-01T00:00:00', 'UTC time leap second T+1' );
}

{
    ...
    is( $dt->Text::PSTemplate::DateTime, '1997-07-01T23:59:59',
        'local time end of leap second day' );

    $dt->set_time_zone('UTC');

    is( $dt->Text::PSTemplate::DateTime, '1997-07-01T22:59:59',
...

{
    ...
    is( $dt->Text::PSTemplate::DateTime, '1997-06-30T22:59:59', '-0100 time leap second T-1' );
...

{
    ...
    is( $dt->Text::PSTemplate::DateTime, '1997-06-30T22:59:60', '-0100 time leap second T-0' );
...

{
    ...
    is( $dt->Text::PSTemplate::DateTime, '1997-06-30T23:00:00', '-0100 time leap second T+1' );
...

{
    ...
    is( $dt->Text::PSTemplate::DateTime, '1997-07-01T00:59:60', '+0100 time leap second T-0' );
}

{
    ...
    is( $dt->Text::PSTemplate::DateTime, '1997-07-01T01:00:00', '+0100 time leap second T+1' );
}

{
    ...
    is( $dt->Text::PSTemplate::DateTime, '1997-06-30T23:59:59',
        'UTC time end of leap second day' );

    $dt->set_time_zone('+0100');

    is( $dt->Text::PSTemplate::DateTime, '1997-07-01T00:59:59',
...

{
    ...
    $dt->add( seconds => 1 );
    is( $dt->Text::PSTemplate::DateTime, '2005-12-31T23:59:60', 'dt is 2005-12-31T23:59:60' );

    $dt->add( seconds => 1 );
    is( $dt->Text::PSTemplate::DateTime, '2006-01-01T00:00:00', 'dt is 2006-01-01T00:00:00' );
}
...
# _non-leapsecond_ second addition
{
    ...
    $dt->add( seconds => 1 );
    is( $dt->Text::PSTemplate::DateTime, '2005-12-30T23:59:59', 'dt is 2005-12-30T23:59:59' );

    $dt->add( seconds => 1 );
    is( $dt->Text::PSTemplate::DateTime, '2005-12-31T00:00:00', 'dt is 2005-12-31T00:00:00' );
}

{
    for my $date (
        ...
        ok( $dt,
            "We can make a Text::PSTemplate::DateTime object for the leap second on $formatted"
        );
    }
}
