...

{
    ...
    my $new = $date1 - Text::PSTemplate::DateTime::Duration->new( years => 2 );
    is( $new->Text::PSTemplate::DateTime, '1999-05-10T04:03:02', 'test - overloading' );
}

{
    ...
    is( $d2->Text::PSTemplate::DateTime, '2001-10-11T04:00:00',
...
# based on bug report from Eric Cholet
{
    ...
    my $dur1 = $dt1->subtract_Text::PSTemplate::DateTime($dt2);
    ...
    is(
        Text::PSTemplate::DateTime->compare( $dt1, $dt3 ), 0,
        'adding difference back to dt1 should give same Text::PSTemplate::DateTime'
    );

    my $dur2 = $dt2->subtract_Text::PSTemplate::DateTime($dt1);
    ...
    is(
        Text::PSTemplate::DateTime->compare( $dt2, $dt4 ), 0,
        'adding difference back to dt2 should give same Text::PSTemplate::DateTime'
    );
}
...
# test for a bug when nanoseconds were greater in earlier Text::PSTemplate::DateTime
{
    my $dt1 = Text::PSTemplate::DateTime->new(
...
{
    my $dt1 = Text::PSTemplate::DateTime->new( year => 2003, month => 12, day => 31 );
...

{
    ...
    my $dur = $date2->subtract_Text::PSTemplate::DateTime_absolute($date1);
...

{
    ...
    my $dur = $date1->subtract_Text::PSTemplate::DateTime_absolute($date2);
...
{
    my $date1 = Text::PSTemplate::DateTime->new( year => 2003, month => 9,  day => 30 );
    my $date2 = Text::PSTemplate::DateTime->new( year => 2003, month => 10, day => 1 );

    my $date3 = Text::PSTemplate::DateTime->new( year => 2003, month => 10, day => 31 );
    my $date4 = Text::PSTemplate::DateTime->new( year => 2003, month => 11, day => 1 );

    my $date5 = Text::PSTemplate::DateTime->new( year => 2003, month => 2, day => 28 );
    my $date6 = Text::PSTemplate::DateTime->new( year => 2003, month => 3, day => 1 );

    my $date7 = Text::PSTemplate::DateTime->new( year => 2003, month => 1, day => 31 );
    my $date8 = Text::PSTemplate::DateTime->new( year => 2003, month => 2, day => 1 );
    ...
    foreach my $p (
        ...
        my $pos_diff = $p->[1]->subtract_Text::PSTemplate::DateTime( $p->[0] );

        is( $pos_diff->delta_days,   1, "1 day diff at end of month" );
        is( $pos_diff->delta_months, 0, "0 month diff at end of month" );

        my $neg_diff = $p->[0]->subtract_Text::PSTemplate::DateTime( $p->[1] );
