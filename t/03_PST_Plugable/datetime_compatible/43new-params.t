...
throws_ok { Text::PSTemplate::DateTime->new( year => 10.5 ) } qr/is an integer/,
    'year must be an integer';
throws_ok { Text::PSTemplate::DateTime->new( year => -10.5 ) } qr/is an integer/,
    'year must be an integer';

throws_ok { Text::PSTemplate::DateTime->new( year => 10, month => 2.5 ) } qr/an integer/,
    'month must be an integer';

throws_ok { Text::PSTemplate::DateTime->new( year => 10, month => 2, day => 12.4 ) }
qr/an integer/, 'day must be an integer';

throws_ok { Text::PSTemplate::DateTime->new( year => 10, month => 2, day => 12, hour => 4.1 ) }
