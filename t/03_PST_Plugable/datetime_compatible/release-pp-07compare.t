...
# comparison with floating time
{
    ...
    is( Text::PSTemplate::DateTime->compare( $date1, $date2 ), 0,
    ...
    is(
        Text::PSTemplate::DateTime->compare_ignore_floating( $date1, $date2 ), 1,
        'Comparison with floating time (cmp)'
    );
}
...
# sub-second
{
    ...
    is( Text::PSTemplate::DateTime->compare( $date1, $date2 ), -1,
        'Comparison with floating time (cmp)' );
...

{
    ...
    is( ( $date1 cmp $date2 ), 0, 'Comparison with floating time (cmp)' );
    is(
        Text::PSTemplate::DateTime->compare_ignore_floating( $date1, $date2 ), 0,
