...
chop => 1 causes a line break reduced right after closeing delimiter.
...
Text::PSTemplate::inline_data() options.
...
=head3 Getting mother template
    ...
    sub your_func : TplExport {
        ...
        my $mother1 = Text::PSTemplate:mother;
        my $mother2 = Text::PSTemplate:get_file_mother;
    }

With Text::PSTemplate::mother, you can get a template instance witch is the one
your_func is being parsed by.

With Text::PSTemplate::get_file_mother, you can get the closest template
instance which is the one current file is being parsed by.

=head3 Getting file name

    sub your_func : TplExport {
        
        my $mother = Text::PSTemplate:context;
    }

With Text::PSTemplate:context, you can get current file name.

=head3 Getting block data

    sub your_func : TplExport {
        
        my $data1 = Text::PSTemplate:inline(0);
        my $data2 = Text::PSTemplate:inline(1);
        # ...
    }
